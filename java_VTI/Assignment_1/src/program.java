...
class Program {
    public static void main(String[] args) {
        ...
        System.out.println("departmentid:" + account3.departmentID.getID());
        System.out.println("positionid:" + account3.positionID.getID());
        ...
        System.out.println("CreatorID:" + group1.creatorID.getID());
        ...
        System.out.println("GrID:" + GA2.groupID.getID());
        System.out.println("AccountID:" + GA2.accountID.getID());
        ...
        System.out.println("CategoryID:" + Q2.categoryID.getID());
        System.out.println("TypeID:" + Q2.typeID.getID());
        System.out.println("CreatorID:" + Q2.creatorID.getID());
        ...
        System.out.println("ExamID:" + EQ1.examID.getID());
        System.out.println("QuestionID:" + EQ1.questionID.getID());
